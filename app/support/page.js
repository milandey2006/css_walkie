      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow group flex flex-col items-center text-center">
            ...
            <a href="mailto:walkietalkie@championsecuritysystem.com" className="text-xl font-bold text-blue-600 hover:text-blue-700 transition-colors">walkietalkie@championsecuritysystem.com</a>
          </div>
